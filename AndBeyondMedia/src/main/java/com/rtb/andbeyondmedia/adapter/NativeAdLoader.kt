...
class NativeAdLoader(private val mediationNativeAdConfiguration: MediationNativeAdConfiguration,
    ...
    fun loadAd() {
        ...
        val request = AndBeyondAdapter.createAdRequest(mediationNativeAdConfiguration)
    ...
    override fun onAdFailedToLoad(p0: LoadAdError) {
        ...
        mediationAdLoadCallback.onFailure(AndBeyondError.createSampleSdkError(ErrorCode.BAD_REQUEST))
    }
